---
title: 'Prerequisites'
description: 'Everything you need before starting your startup journey'
icon: CircleCheck
---
...
<Warning>
**Agency Users**: Create all accounts using your **agency's company email** and transfer ownership later. See the [Account Management Guide](/agency-related/account-management-guide) for details.
</Warning>

### Required for All Setups
- **GitHub Repository**: Create an empty private repository
...
- **Railway (or Self-Hosting)** - Deployment platforms
...
<Cards>
  <Card title="Setup Guide" href="/setup/2-project-setup" description="Start building your project" />
  <Card title="Idea Validation" href="/building-with-kaizen/idea-validation" description="Validate before you build" />
  <Card title="Join Community" href="https://www.skool.com/ai-mvp-builders/about" description="Connect with other builders" />
</Cards>

Once you have all prerequisites ready, proceed to [Step 2: Project Setup](/setup/2-project-setup).
