...
function Dashboard() {
  ...
  if (isLoading) return null; // ❌ Jarring blank screen
...
<Cards>
  <Card title="Debugging Guide" href="/building-with-kaizen/debugging-guide" description="Fix performance bugs" />
  <Card title="Production Deployment" href="/setup/8-production-deployment" description="Deploy optimized builds" />
  <Card title="Observability" href="/building-with-kaizen/observability" description="Monitor performance in production" />
</Cards>
