...
<Cards>
  <Card title="Rapid UI Prototyping" href="/building-with-kaizen/rapid-ui-prototyping" description="Build beautiful UIs quickly" />
  <Card title="Debugging Guide" href="/building-with-kaizen/debugging-guide" description="Fix any bug efficiently" />
  <Card title="Performance" href="/building-with-kaizen/performance" description="Optimize app performance" />
</Cards>
