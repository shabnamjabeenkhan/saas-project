        ...
        >
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:flex-nowrap lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                {!menuState && <Menu className="m-auto size-6" />}
                {menuState && <X className="m-auto size-6" />}
              </button>
            </div>
            ...
            {menuState && (
              <div className="bg-background block lg:hidden fixed top-20 left-0 right-0 w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap z-40">
